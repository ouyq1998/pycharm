...
if __name__ == '__main__':
    ...
    from databricks import sql
    hostname = 'adb-6141521119240036.0.databricks.azure.cn'
    http_path = 'sql/protocolv1/o/6141521119240036/0901-161346-myrk1xmk'
    token = 'dapic788329800b6110ad36192d326defa87'
